      ...
      <div className="work-experience__list">
        <div className="work-experience__item">
          <div className="work-experience__image-wrapper">
            <img
              src={logos.Sonik_T}
              alt={t("skills.Sonik.imgAlt")}
              className="work-experience__image"
            />
          </div>
          <div className="work-experience__info">
            ...
            />
            <span className="work-experience__years">
              {t("skills.Sonik.july")} 2024 – {t("skills.Sonik.august")} 2025
            </span>
          </div>
        </div>
        <div className="work-experience__item">
          <div className="work-experience__image-wrapper">
            <AppIconWrapper
              Icon={icon}
              iconSize={30}
              alt={t("skills.selfEmployed.imgAlt")}
            />
          </div>
          <div className="work-experience__info">
            <AppTextBlock
            ...
            />
            <span className="work-experience__years">
              {t("skills.selfEmployed.september")} 2017 –{" "}
              {t("skills.selfEmployed.may")} 2024
            </span>
          </div>
        </div>
      </div>
